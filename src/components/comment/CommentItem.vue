    ...
    <div>
      ...
      <div class="me-view-comment-tools">
        <a class="me-view-comment-tool" @click="showComment(-1)">
          <i class="me-icon-comment" />&nbsp; 评论
        </a>
      </div>

      <div class="me-reply-list">
        <div v-for="c in comment.childrens" :key="c.id" class="me-reply-item">
          ...
          <div class="me-view-meta">
            ...
            <a class="me-view-comment-tool" @click="showComment(c.id, c.author)">
              <i class="me-icon-comment" />&nbsp;回复
            </a>
          </div>
        </div>

        <div v-show="commentShow" class="me-view-comment-write">
          <el-input
            ...
            resize="none"
          />
          <el-button style="margin-left: 8px" type="text" @click="publishComment()">评论</el-button>
        </div>
      </div>
