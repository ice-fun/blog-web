      ...
      <el-col v-if="!simple" :span="12" :offset="0">
        ...
        >
          ...
          <el-col :span="2" :offset="1">
            <el-menu-item index="/write"><i class="el-icon-edit" />写文章</el-menu-item>
          </el-col>
        ...
        <el-menu :router="true" menu-trigger="click" mode="horizontal" active-text-color="#5FB878">
          ...
          <template v-else>
            <el-submenu index>
              ...
              <el-menu-item index @click="logout"><i class="el-icon-back" />退出</el-menu-item>
            </el-submenu>
          </template>
        </el-menu>
      </el-col>
...
export default {
  ...
  computed: {
    user() {
      const login = this.$store.state.user.name !== 0
