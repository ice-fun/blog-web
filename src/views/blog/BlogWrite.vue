    ...
    <el-container>
      ...
      <el-container class="me-area me-write-box">
        <el-main class="me-write-main">
          ...
          <div id="placeholder" style="visibility: hidden;height: 89px;display: none;" />
          <markdown-editor :editor="articleForm.editor" class="me-write-editor" />
        </el-main>
      </el-container>
      ...
      >
        ...
        <el-form ref="articleForm" :model="articleForm" :rules="rules">
  ...
  methods: {
    getArticleById(id) {
      ...
      getArticleById(id).then(data => {
        ...
        const tags = this.articleForm.tags.map(function(item) {
          return item.id
        })
    ...
    editorToolBarToFixed() {
      const toolbar = document.querySelector('.v-note-op')
