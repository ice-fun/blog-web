<template>
  <div v-title class="me-view-body" :data-title="title">
      ...
      <el-main>
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            ...
            <el-button v-for="t in article.tags" :key="t.id" size="mini" type="primary" round plain @click="tagOrCategory('tag', t.id)">{{ t.tagName }}</el-button>
          </div>

          <div class="me-view-tag">
            文章分类：
            <!--<span style="font-weight: 600">{{article.category.categoryname}}</span>-->
            <el-button size="mini" type="primary" round plain @click="tagOrCategory('category', article.category.id)">{{ article.category.categoryName }}</el-button>
          </div>
            ...
            <div class="me-view-comment-write">
              ...
              <el-row :gutter="20">
                <el-col :span="3" :offset="21">
                  <el-button type="text" style="margin-top: 5px;" @click="publishComment()">评论</el-button>
                </el-col>
              </el-row>
            </div>
