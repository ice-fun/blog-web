<template>
  <div v-title class="me-allct-body" :data-title="categoryTagTitle">
    <el-container class="me-allct-container">
      <el-main>
        <el-tabs v-model="activeName">
          <el-tab-pane label="文章分类" name="category">
            <ul class="me-allct-items">
              <li v-for="c in categorys" :key="c.id" class="me-allct-item" @click="view(c.id)">
          ...
          <el-tab-pane label="标签" name="tag">
            <ul class="me-allct-items">
              <li v-for="t in tags" :key="t.id" class="me-allct-item" @click="view(t.id)">
                <div class="me-allct-content">
                  <a class="me-allct-info">
